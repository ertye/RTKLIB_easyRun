We can use WSL to make \app\consapp,
such as in \app\consapp\rnx2rtkp\gcc, directly input 'make', then we can get bin in gcc.
(we can delete '-lgfortran' in makefile)
